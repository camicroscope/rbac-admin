 ...
 * Expander
 *
 * this function converts the JSON object from a condensed from received
 * from the server into an expanded form suitable for react and easy
 * state managemement.
 */
export const expander = (x) => {
